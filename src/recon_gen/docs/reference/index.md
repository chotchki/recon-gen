...
Per-app structural reference: what each sheet shows, which dataset backs
it, which filters and drills are wired and which L1 invariants each row
represents. The reader is the operator looking up "what does column X on
