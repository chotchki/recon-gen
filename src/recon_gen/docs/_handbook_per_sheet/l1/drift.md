...
said; the stored balance still says what *it* always said; the difference
is locked in.
...
prior-day balance. Cross to the CL.6 invariant sheet (if exposed on this L2) to see
whether the operator's expected emit cadence matches what they're sending.
