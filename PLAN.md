...
- [ ] AI.14 - **BB.2 form completeness + structured pickers** (consolidates AI.14 + AI.15 per user 2026-05-25; defer until post-AM Tailwind sweep so visual chrome is unified first). One scope with three sub-pieces — they all touch the same set of forms and share the per-rail-checkbox-picker design:
