...
- [x] **Y.2.b — Account Network dataset: `pInvANetworkAnchor` + `pInvANetworkMinAmount`.** Two params on one dataset.
    ...
    - [x] **Y.2.b.8 — Aurora deploy + verify.** Deployed in same roll as Y.2.a (commit `6db9f3e`). All 4 dashboards `CREATION_SUCCESSFUL`; API e2e green (48/48); Investigation browser e2e green (28 passed). Initial-paint behavior pending manual user verification.
