...
- [ ] BC.13 - Commit + tag. **In progress** — `__version__` bumped to 11.19.0; RELEASE_NOTES.md drafted with the full BC.0-BC.14 story + migration/breaking-changes section. Push tag pending operator confirmation; CI verify happens on the push (e2e-against-testpypi job will be the moment of truth for the PyPI-publish-unblock claim).
