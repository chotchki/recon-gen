...
class TestOracleTypeNames:
    def test_serial_type(self):
        # CB.17.i — switched from `GENERATED ALWAYS` to `GENERATED BY
        # DEFAULT` so the V-overlay clone (INSERT ... SELECT *) can
        # supply the identity values without ORA-32795.
        assert serial_type(ORA) == "NUMBER GENERATED BY DEFAULT AS IDENTITY"
