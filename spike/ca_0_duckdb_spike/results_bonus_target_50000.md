# CA.0 DuckDB matview perf — base_tx_rows=12,844 (bonus: PG-style correlated CSB body)
...
- seed apply wallclock: 7333 ms
- **bundled refresh wallclock (cold; integrator-visible): 189 ms**
- DuckDB file size: 9.2 MB
